...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "FishVisionAR",
            url: "https://github.com/Fiskher/fish-vision-ar-spm/releases/download/0.3.4/FishVisionAR.xcframework.zip",
            checksum: "02262edcaa09eafecaefb41337a7c4e926ec11f89864dd214d1132f10760c607"
        ),
    ]
)
