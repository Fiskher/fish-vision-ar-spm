...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "FishVisionAR",
            url: "https://github.com/Fiskher/fish-vision-ar-spm/releases/download/0.4.4/FishVisionAR.xcframework.zip",
            checksum: "91f90338eb54b8bba2e1f167bf8f9b7f04bae20d3f41759d6e14fdcd0961080e"
        ),
    ]
)
