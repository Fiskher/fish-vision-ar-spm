...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "FishVisionAR",
            url: "https://github.com/Fiskher/fish-vision-ar-spm/releases/download/0.4.0/FishVisionAR.xcframework.zip",
            checksum: "383d2c3a1d4749ea016343799d40a1064c33cc1a9f213bfb566022edd9c392bd"
        ),
    ]
)
